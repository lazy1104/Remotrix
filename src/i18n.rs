...
impl Tr {
    fn key(self) -> &'static str {
        match self {
            ...
            Tr::ConfirmCloseTrayPrefHint => "confirm-close-tray-pref-hint",
            Tr::CloseAction => "close-action",
            Tr::TrayAction => "tray-action",
            Tr::Tray => "tray",
            Tr::TrayEnabled => "tray-enabled",
            Tr::CloseToTray => "close-to-tray",
            Tr::CloseToTrayHint => "close-to-tray-hint",
            Tr::TrayRestartHint => "tray-restart-hint",
