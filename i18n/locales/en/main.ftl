...
confirm-close-tray-pref-hint = Future closures will minimize to tray without asking. You can change this in Settings; the tray must be enabled.
close-action = Close
tray-action = Minimize to Tray
tray = Tray
tray-enabled = Show system tray icon
close-to-tray = Close to tray
close-to-tray-hint = When enabled, closing the window minimizes to tray and skips the confirm dialog.
tray-restart-hint = Enabling the tray takes effect after restarting the app.
